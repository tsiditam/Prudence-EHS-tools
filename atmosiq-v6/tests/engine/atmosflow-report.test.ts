/**
 * AtmosFlow Word report — the EDITABLE, WATERMARK-FREE Word deliverable, built
 * 1:1 to the AtmosFlow Figma design and data-driven from the render model.
 *
 * Builds a small assessment fixture, assembles the RENDER MODEL from it the
