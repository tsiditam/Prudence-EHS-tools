...
const SAMPLE_MODEL = {
  ...
  severityLegendNote: 'Acceptable: within recognized references. Advisory: monitor / investigate source. Elevated: corrective action recommended. Priority: prompt action recommended.',
  overallStatement: `Most zones presented acceptable ventilation, comfort, and air-quality indicators. One interior conference room (Zone 8-D) showed a carbon-dioxide trend consistent with possible under-ventilation relative to occupant load during a high-occupancy meeting (an inference from the CO2 trend, not a measured ventilation rate), and two zones (8-F copy/print room and 12-B break room) showed advisory-tier particulate and VOC readings indicating identifiable local sources. Carbon monoxide, temperature, and humidity were within their references in every zone. Each finding below carries a confidence rating and the verification it would need; recommended actions in Section 5 follow a verify-before-invest ladder.`,
  scope: {
    paras: [
      ...
      'The objective was to characterize indoor air quality indicators and to (a) confirm whether observed conditions fall within recognized comfort and ventilation references, (b) identify any zones warranting follow-up, and (c) provide a defensible, prioritized action list. The assessment did not include integrated time-weighted-average sampling, microbial sampling, or destructive investigation.',
    ],
  ...
  methodology: {
    ...
    referenceFramework: 'Outcomes are compared against recognized consensus and regulatory references: ASHRAE 62.1-2022 (ventilation, used as an indicator basis for CO2 — not a CO2 contaminant limit), ASHRAE 55-2020 (thermal comfort), US EPA NAAQS (CO and PM2.5), OSHA PELs (29 CFR 1910.1000), and the Mølhave (1991) advisory tiers for TVOC. References contextualize the readings; they are not applied as compliance determinations.',
  },
  results: {
    ...
    parameters: [
      ...
      { title: 'Fine particulate (PM2.5)', body: [
        ...
        'Observed: PM2.5 ranged 6–18 µg/m³ (site mean 11 µg/m³) — generally low and comparable to values commonly observed in mechanically ventilated office environments. For scale only, the US EPA 24-hour NAAQS is 35 µg/m³; NAAQS are outdoor, population-level standards built on long-term epidemiology, not office or occupational limits, and are cited here for context rather than as a pass/fail threshold. The copy/print room (Zone 8-F, 18 µg/m³) and break room (Zone 12-B, 16 µg/m³) read modestly higher than quieter office zones, consistent with intermittent laser-printer and cooking activity — local, transient sources rather than a building-wide condition.',
      ] },
  ...
  logger: {
    disclaimer: 'The following timelines were generated from uploaded sensor logger data. Interpretation should be reviewed by a qualified IAQ professional; AtmosFlow does not make compliance determinations.',
  ...
  findings: {
    intro: 'Findings are ranked by recommended response and carried with a confidence rating. Confidence reflects the weight of supporting evidence (logger trend, outdoor baseline, replication) against what was not measured (airflow, compound speciation); it is not a probability. No finding constitutes a regulatory exposure determination.',
    rows: [
      { z: '8-D', sev: 'elevated', conf: 'Moderate', f: 'CO2 reached 1,247 ppm during a six-person meeting — consistent with possible under-ventilation relative to occupant load. An inference from the CO2 trend, not a measured ventilation rate.' },
      ...
      { z: 'All others', sev: 'ok', conf: 'Moderate', f: 'All indicators within recognized references.' },
    ],
  },
  reportedConcerns: {
    intro: 'Occupant interviews during the walkthrough surfaced the concerns below, mapped to a plausible pathway and the evidence that does — or does not — support it. Occupant reports are subjective and are used to direct measurement, not to replace it.',
    rows: [
      ...
      { c: 'Isolated eye / throat irritation', pw: 'Source unknown', e: 'Not supported — no corroborating measurement', color: SOFT },
    ],
  },
  conceptualModel: {
  ...
  workingHypotheses: {
    intro: 'The data support the hypotheses below. None is a confirmed cause; each names the verification it requires before it should be relied upon for capital decisions.',
    items: [
      ...
      'No evidence of water intrusion, visible microbial growth, or combustion spillage was observed during the walkthrough (visual inspection only).',
    ],
  },
  recommendations: {
    intro: 'Recommendations follow a verify-before-invest ladder: confirm the suspected cause, correct it, re-test, and only then consider permanent monitoring or capital changes. Priorities reflect the evidence gathered, not a confirmed diagnosis.',
    immediate: [
    ...
    mediumTerm: [
      ...
      'If monitoring confirms a persistent occupancy-driven pattern, then evaluate demand-controlled ventilation for those zones. Permanent BAS sensor integration is a capital decision that should follow verification, not a single excursion.',
      'Document as-designed versus as-installed ventilation rates in the building O&M records, and schedule a follow-up assessment after corrective work.',
    ],
  },
  qaQc: [
  ...
  limitations: [
    ...
    'In particular, ventilation-related findings are inferences from CO2 behavior, not measured airflow or ventilation rates; they should be confirmed by direct airflow, BAS-trend, or test-and-balance evaluation before any remedial investment. Occupant concerns were gathered through informal interview and are not a substitute for a structured symptom or complaint survey. Confidence ratings express the relative weight of available evidence, not a statistical probability.',
  ],
  review: {
    statement: 'The undersigned has reviewed the measurements, findings, and recommendations in this report and asserts professional judgment on the interpretations and the prioritized actions in Section 5.',
  ...
  about: {
    ...
    text: 'AtmosFlow is an IAQ assessment platform: it captures field observations and direct-reading measurements, compares them against recognized references, and assembles a consultant-grade report for review by a qualified industrial hygienist or EHS professional. It identifies risk indicators and produces prioritized follow-up — it does not make regulatory classifications or compliance determinations. This sample uses fictitious data to illustrate structure and tone. Learn more at atmosflow.net.',
  },
  photos: {
