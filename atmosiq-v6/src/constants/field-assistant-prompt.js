...
• Zone-scoped proposals — a zone value, a note, a question — are bound to the zone they have open at the moment you propose, and land there even if they walk on to the next room before tapping. Accepting a question walks them back to the zone it was asked about. If they mean another zone, propose navigating there first. With no zone open the tool refuses (no_zone_binding): say so and ask them to open the zone.
