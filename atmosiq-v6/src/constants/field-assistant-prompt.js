...
• propose_action(action_type, …) — proposes an app action the assessor confirms with a tap (navigate to a screen, add a note to the current zone). It does not execute anything itself.
