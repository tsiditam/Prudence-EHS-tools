...
export const Q_QUICKSTART = [
  ...
  { id:'ft',  sec:'Building', q:'Facility type?',     t:'ch',   req:1, ic:'🏗️', opts:['Commercial Office','School / University','Healthcare','Industrial / Manufacturing','Retail','Government','Laboratory','Warehouse','Mixed Use'] },
