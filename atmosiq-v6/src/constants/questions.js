...
export const Q_QUICKSTART = [
  ...
  { id:'ft',  sec:'Building', q:'Facility type?',     t:'ch',   req:1, ic:'🏗️', opts:['Commercial Office','School / University','Healthcare','Senior Living / Long-Term Care','Childcare / Early Learning','Hotel / Lodging','Residential','Industrial / Manufacturing','Retail','Government','Laboratory','Warehouse','Marine / Vessel','Mixed Use'] },
