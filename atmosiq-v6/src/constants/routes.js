...
export const ROUTES = {
  ...
  sites: { label: 'Site library', short: 'Sites', reachedBy: ['settings'], parent: 'settings', restore: true },
  'report-templates': { label: 'Report templates', short: 'Templates', reachedBy: ['settings'], parent: 'settings', restore: true },
