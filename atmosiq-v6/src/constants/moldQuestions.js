...
export const Q_MOLD_PRESURVEY = [
  ...
  { id: 'mps_hvac_involved', sec: 'Mold Context', q: 'Is HVAC implicated as a moisture source or pathway?', t: 'ch', sk: 1, ic: '❄️', opts: YES_NO },
...
export const Q_MOLD_ZONE = [
  ...
  { id: 'mz_porous', sec: 'Growth', q: 'Is the affected material porous (drywall, carpet, ceiling tile)?', t: 'ch', sk: 1, ic: '🏗️', opts: YES_NO, cond: { f: 'mz_visible_growth', eq: 'Yes' } },
