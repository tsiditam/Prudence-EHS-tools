...
const SHORT_STATEMENT_BY_CONDITION: Partial<Record<ConditionType, string>> = {
  ...
  occupant_symptoms_anecdotal: 'Occupants reported symptoms; a structured symptom survey was not performed. This screening does not characterize occupant health.',
