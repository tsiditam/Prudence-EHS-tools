...
const SHORT_STATEMENT_BY_CONDITION: Partial<Record<ConditionType, string>> = {
  ...
  co_screening_elevated: 'Carbon monoxide levels were elevated relative to typical indoor conditions.',
  hcho_above_pel_documented: 'Formaldehyde measurement exceeded the OSHA permissible exposure limit.',
  hcho_screening_elevated: 'Formaldehyde levels were elevated relative to typical indoor conditions.',
  tvoc_screening_elevated: 'Total VOC levels were elevated; speciation is recommended to identify sources.',
  pm_above_naaqs_documented: 'PM2.5 measurement exceeded the EPA NAAQS 24-hour standard.',
  pm_screening_elevated: 'PM2.5 levels were elevated relative to outdoor or expected indoor conditions.',
  pm_indoor_amplification_screening: 'Indoor PM2.5 levels exceeded outdoor levels, suggesting an indoor source.',
  particle_screening_only: 'Particulate conditions were identified that warrant follow-up.',
  ...
  occupant_symptoms_anecdotal: 'Occupants reported symptoms; a structured symptom survey was not performed. This evaluation does not characterize occupant health.',
  occupant_cluster_anecdotal: 'Similar occupant symptoms were reported in a localized area.',
  symptoms_resolve_away_from_building: 'Occupants report symptoms improve when away from the building (self-reported observation; not a medical or building-related-illness determination).',
...
const LEAD_TERM_BY_CONDITION: Record<ConditionType, string> = {
  ...
  co_screening_elevated: 'Carbon monoxide',
  hcho_above_pel_documented: 'Formaldehyde (above OSHA PEL)',
  hcho_screening_elevated: 'Formaldehyde',
  tvoc_screening_elevated: 'Total VOCs',
  pm_above_naaqs_documented: 'PM2.5 (above EPA NAAQS)',
  pm_screening_elevated: 'PM2.5',
