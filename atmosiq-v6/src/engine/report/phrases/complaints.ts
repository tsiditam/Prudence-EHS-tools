...
export const COMPLAINTS_PHRASES: Partial<Record<ConditionType, PhraseLibraryEntry>> = {
  occupant_symptoms_anecdotal: {
    ...
    intentTemplate:
      'Occupant feedback was noted anecdotally. A structured symptom survey was not conducted at the time of assessment, and this environmental evaluation does not characterize occupant health.',
    bannedAlternatives: [
  ...
  occupant_cluster_anecdotal: {
    ...
    intentTemplate:
      'Multiple occupants in the same localized area reported similar symptoms. Formal epidemiological evaluation was not performed, and this environmental evaluation does not characterize occupant health.',
    bannedAlternatives: [
  ...
  symptoms_resolve_away_from_building: {
    ...
    intentTemplate:
      'Occupants report that symptoms improve when away from the building. This is a self-reported observation only; it is not a building-related-illness determination. Characterizing it requires a structured occupant symptom survey and medical/occupational-health evaluation, which are outside the scope of this environmental evaluation.',
    bannedAlternatives: [
