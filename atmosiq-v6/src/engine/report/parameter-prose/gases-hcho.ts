 ...
 * level 0.5 ppm), NIOSH REL 0.016 ppm (10-hour TWA) with 0.1 ppm ceiling, the substantial gap
...
const HCHO_BACKGROUND = `Formaldehyde is a building-material and product-emission contaminant regulated under the dedicated formaldehyde standard at 29 CFR 1910.1048. The Occupational Safety and Health Administration Permissible Exposure Limit is 0.75 parts per million as an 8-hour Time Weighted Average, with a Short-Term Exposure Limit of 2.0 parts per million for any 15-minute period and an Action Level of 0.5 parts per million as an 8-hour Time Weighted Average. The National Institute for Occupational Safety and Health Recommended Exposure Limit is 0.016 parts per million as a Time Weighted Average for up to a 10-hour workday with a 0.1 parts per million ceiling, established as a health-protective recommendation. The substantial gap between the NIOSH REL and the OSHA PEL reflects different regulatory and technical bases — NIOSH RELs are health-protective recommendations, while the OSHA PEL incorporates technical and economic feasibility. Direct-reading formaldehyde instruments, including electrochemical and photoacoustic models, have meaningful specificity limitations and may respond to interfering compounds; observed values near the NIOSH REL ceiling cannot reliably be distinguished from instrument noise. NIOSH Method 2016 (2,4-dinitrophenylhydrazine — DNPH — cartridge sampling, 2 to 4 hour Time Weighted Average) is the confirmatory analytical method appropriate when instrument-based measurements warrant formal exposure assessment.`
...
export const HCHO_PROSE: ParameterProse = {
  ...
  applicableStandards: [
    ...
    { source: 'NIOSH REL — Formaldehyde 0.016 ppm 10-hour TWA, Ceiling 0.1 ppm', authority: 'consensus', edition: 'current' },
