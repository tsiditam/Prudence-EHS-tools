...
export const CIH_REQUIRED_LIMITATION =
  'This report does not constitute a comprehensive industrial hygiene exposure assessment. Findings are based on professional judgment within the stated limitations.'
