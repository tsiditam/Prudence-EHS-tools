...
export default function Loading({ onDone, fast }) {
  ...
  const phs = ['Initializing atmosflow','Loading standards','Calibrating','Ready']
  ...
  if(fast) return <div style={{position:'fixed',inset:0,background:'#080A0E',display:'flex',alignItems:'center',justifyContent:'center',zIndex:9999}}><div style={{fontSize:28,fontWeight:700}}>atmos<span style={{color:'#22D3EE'}}>flow</span></div></div>
  return (
    <div style={{position:'fixed',inset:0,background:'#080A0E',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',zIndex:9999}}>
      ...
      <div style={{position:'relative',zIndex:1,textAlign:'center'}}>
        ...
        <div style={{fontSize:22,fontWeight:700}}>atmos<span style={{color:'#22D3EE'}}>flow</span></div>
