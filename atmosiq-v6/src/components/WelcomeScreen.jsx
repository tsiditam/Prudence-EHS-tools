 ...
 * Shows once before profile setup, explains what atmosIQ does.
 */
      ...
      <div style={{maxWidth:400,width:'100%',textAlign:'center'}}>
        ...
        <div style={{marginBottom:40}}>
          <div style={{display:'inline-flex',alignItems:'center',gap:10}}>
            ...
            <span style={{fontSize:22,fontWeight:700,letterSpacing:'-0.3px'}}>atmos<span style={{color:ACCENT}}>IQ</span></span>
          </div>
        </div>
