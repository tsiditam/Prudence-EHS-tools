 ...
 * All rights reserved.
 *
 * HydroScan icon system — the brand Logo (water drop + analysis pulse) and
 * the inline SVG icon set `I`. Extracted from the App.jsx monolith (Phase 1c)
 * so the app shell, screens, and the Marlow assistant share one icon source.
 */
